...
{
    // given string
    // to find the length of longest subarrays contatining only ones

    // we can change upto 'k' 0s -> 1s
    ...
    // we will find the longest subarray with k zeros
    // making the window:

    int zcount = 0, i = 0, ans = 0;
    rep(j, 0, n)
    {
        if (a[j] == 0)
        {
